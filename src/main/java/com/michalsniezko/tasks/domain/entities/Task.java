package com.michalsniezko.tasks.domain.entities;
...
public class Task {
    ...
    public Task(UUID id, TaskPriority priority, String title, String description, LocalDateTime dueDate, TaskStatus status, LocalDateTime created, LocalDateTime updated) {
